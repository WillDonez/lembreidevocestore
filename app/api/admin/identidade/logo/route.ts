  ...
  try {
    ...
    if (!url) {
      return NextResponse.json(
        {
          erro:
            "Não foi possível gerar a URL pública do logotipo.",
        },
        {
          status: 500,
        },
    ...
    console.error(
      "Erro interno no upload do logotipo:",
      error,
    );
    ...
    return NextResponse.json(
      {
        erro:
          "Ocorreu um erro interno ao enviar o logotipo.",
      },
      {
        status: 500,
      },
