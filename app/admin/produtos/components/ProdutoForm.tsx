          ...
          <div className="mt-6">
            ...
            <div className="mb-3 flex flex-wrap gap-2">
              <button
                ...
                className="rounded-lg border border-primary/30 bg-[color-mix(in_srgb,var(--primary)_8%,white)] px-3 py-2 text-sm font-bold text-primary transition hover:border-primary"
              >
                Título
              </button>
              ...
              <button
                ...
                className="rounded-lg border border-border bg-background px-3 py-2 text-sm font-bold text-text transition hover:border-primary hover:text-primary"
              >
                Lista
              </button>
            ...
            <div className="mt-3 rounded-xl border border-border bg-background px-4 py-3 text-sm leading-6 text-text-light">
              <span className="font-bold text-text">Dica de formatação:</span>{" "}
              <code className="font-bold text-primary">## Título</code> cria um título,
              {" "}
              <code className="font-bold text-primary">- Item</code> cria uma lista e
